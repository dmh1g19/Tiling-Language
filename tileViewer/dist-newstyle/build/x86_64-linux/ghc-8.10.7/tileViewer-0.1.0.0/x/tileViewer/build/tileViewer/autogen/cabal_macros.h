...
/* package tileViewer-0.1.0.0 */
#ifndef VERSION_tileViewer
#define VERSION_tileViewer "0.1.0.0"
#endif /* VERSION_tileViewer */
#ifndef MIN_VERSION_tileViewer
#define MIN_VERSION_tileViewer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_tileViewer */
...
#define CURRENT_COMPONENT_ID "tileViewer-0.1.0.0-inplace-tileViewer"
